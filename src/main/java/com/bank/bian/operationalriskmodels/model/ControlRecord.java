package com.bank.bian.operationalriskmodels.model;
...
/**
 * The BIAN control record for this service domain: "Operational Risk Model Development Project".
 *
 ...
 * to its asset type (Operational Risk Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Operational Risk Model Development Project";
